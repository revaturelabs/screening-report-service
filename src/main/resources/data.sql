...
(SCREENING_SEQUENCE.NEXTVAL, 2, 2, 50.0, 'intoComment2','generalComment2','softskillComment2', '2018-03-02', '2018-03-03', 0, 'Completed', 4322),
...
(SCREENING_SEQUENCE.NEXTVAL, 3, 5, 50.0, 'intoComment8','generalComment8','softskillComment8', '2018-03-12', '2018-03-14', 1, 'Pending', 4328),
(SCREENING_SEQUENCE.NEXTVAL, 3, 5, 50.0, 'intoComment8','generalComment8','softskillComment8', '2018-03-12', '2018-02-14', 1, 'Pending', 4328);
...
(SOFT_SKILL_VIOLATION_SEQUENCE.NEXTVAL, 4323, 4322, 'Was wearing pajamas', '2018-03-03'),
(SOFT_SKILL_VIOLATION_SEQUENCE.NEXTVAL, 4325, 4322, 'Wearing a graphic t-shirt.', '2018-03-04'),
(SOFT_SKILL_VIOLATION_SEQUENCE.NEXTVAL, 4326, 4323, 'Had many people in the same room. Was drinking.', '2018-03-05'),
(SOFT_SKILL_VIOLATION_SEQUENCE.NEXTVAL, 4327, 4323, 'He kept wandering off topic, was browsing a site.', '2018-03-06'),
(SOFT_SKILL_VIOLATION_SEQUENCE.NEXTVAL, 4328, 4323, 'Extremely distracted, was texting.', '2018-03-07');
...
(QUESTION_SCORE_SEQUENCE.NEXTVAL, 10011, 406, 4321, 2, 'some understanding.', '2018-03-01'),
(QUESTION_SCORE_SEQUENCE.NEXTVAL, 10012, 406, 4321, 5, 'good', '2018-03-01'),
(QUESTION_SCORE_SEQUENCE.NEXTVAL, 10007, 414, 4322, 5, 'good', '2018-03-01'),
(QUESTION_SCORE_SEQUENCE.NEXTVAL, 10008, 414, 4322, 1, 'Bad wording, not sure they understand', '2018-03-01'),
(QUESTION_SCORE_SEQUENCE.NEXTVAL, 10009, 414, 4323, 3, 'Basic knowledge, average.', '2018-03-01'),
(QUESTION_SCORE_SEQUENCE.NEXTVAL, 10004, 416, 4322, 2, 'some understanding.', '2018-03-01'),
(QUESTION_SCORE_SEQUENCE.NEXTVAL, 10005, 416, 4324, 5, 'good', '2018-03-01'),
(QUESTION_SCORE_SEQUENCE.NEXTVAL, 10001, 415, 4325, 5, 'good', '2018-03-01'),
(QUESTION_SCORE_SEQUENCE.NEXTVAL, 10002, 415, 4325, 1, 'Bad wording, not sure they understand', '2018-03-01');
