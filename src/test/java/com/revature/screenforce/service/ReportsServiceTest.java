...
public class ReportsServiceTest {
	...
	public void setup() {
		...
		screening = new Screening(123, new ScheduledScreening(123, new Candidate(), ScheduledStatus.SCREENED,
				51, currentDate), 123, 51,
				4.0, "Me", "Good", "Good Eye-Contact",
				currentDate.minusDays(1), null, true, "SCREENED");
	...
	public void testGetSimpleReportModelByRange() {
		...
		assertEquals(1, reportService.getSimpleReportModelByRange(screening.getStartDateTime().minusDays(1), screening.getStartDateTime().plusDays(1)).size());
	}
